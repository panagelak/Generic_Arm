...
if __name__ == '__main__':
    ...
    # Create Subscribers
    pcl_sub = rospy.Subscriber("/camera/depth_registered/points", pc2.PointCloud2, pcl_callback, queue_size=10)
    # Create Publishers
    pcl_objects_pub = rospy.Publisher("/pcl_objects", PointCloud2, queue_size=10)
    pcl_table_pub = rospy.Publisher("/pcl_ground", PointCloud2, queue_size=10)
    pcl_cluster_cloud = rospy.Publisher("/pcl_cluster_objects", PointCloud2, queue_size=10)
